...
public class ut08a4LibrosAdapter extends RecyclerView.Adapter<ut08a4LibrosAdapter.ViewHolder> {
     ...
     * by RecyclerView.
     */
    public ut08a4LibrosAdapter(ArrayList<u6a1Libros> dataSet) {
        datos = new ArrayList<>();
        add(dataSet);
    }
    ...
    @Override
    public ut08a4LibrosAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        // Create a new view, which defines the UI of the list item
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.row_libros, viewGroup, false);

        return new ut08a4LibrosAdapter.ViewHolder(view);
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(ut08a4LibrosAdapter.ViewHolder viewHolder, final int position) {
